        ...
        >
          <p className="theme--detail--dark">
            <ScrambleText delay={2}>
              A skilled frontend developer who excels in crafting
              user-friendly web interfaces. With expertise in HTML, CSS, and
              JavaScript, I bring designs to life with seamless functionality
              and visual appeal. I prioritize performance, compatibility, and
              staying updated with industry trends to deliver elegant solutions
